...
<tr><td><?= e($venta['numero_venta']) ?></td><td><?= e($venta['fecha_venta']) ?></td><td><?= e($venta['caja_nombre']) ?></td><td><?= e($venta['cliente_nombre']) ?></td><td>$ <?= number_format((float) $venta['total'], 2) ?></td><td><a class="btn btn-outline-primary btn-sm" href="<?= e(url('/app/punto-venta/ventas/ver/' . $venta['id'])) ?>">Ver ticket</a></td></tr>
<?php endforeach; ?>

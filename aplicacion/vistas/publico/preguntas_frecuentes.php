...
<section class="py-5 bg-white border-bottom">
    <div class="container">
        <h1 class="display-6 fw-bold mb-3">Preguntas frecuentes sobre planes y sistema de cotizaciones</h1>
        <p class="lead text-secondary mb-0">Resuelve todas tus dudas antes de contratar: funcionalidades, seguridad, implementación, soporte y escalabilidad para empresas.</p>
    </div>
</section>

<section class="py-5">
    <div class="container">
        <div class="accordion" id="faq-completo">
            <?php foreach ($faqs as $indice => $faq): ?>
                <?php
                    $faqId = 'faq-full-' . ($indice + 1);
                    $faqHeading = 'faq-full-heading-' . ($indice + 1);
                    $expandido = $indice === 0;
                ?>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="<?= e($faqHeading) ?>">
                    ...
                    <div id="<?= e($faqId) ?>" class="accordion-collapse collapse <?= $expandido ? 'show' : '' ?>" aria-labelledby="<?= e($faqHeading) ?>" data-bs-parent="#faq-completo">
        ...
        <div class="text-center mt-4">
            <h2 class="h5">¿Listo para elegir tu plan?</h2>
            <p class="text-secondary small">Con esta información puedes tomar una decisión con claridad y avanzar con confianza.</p>
            <div class="d-flex justify-content-center gap-2 flex-wrap">
                <a href="<?= e(url('/planes')) ?>" class="btn btn-primary btn-sm">Ver planes</a>
                <a href="<?= e(url('/contacto')) ?>" class="btn btn-outline-secondary btn-sm">Contactar ventas</a>
            </div>
        </div>
    </div>
</section>
